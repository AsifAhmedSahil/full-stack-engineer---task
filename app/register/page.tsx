...
export default function RegisterPage() {
  ...
  try {
    // Step 1: upload avatar if selected (optional)
    ...
    if (avatarFile) {
      ...
      const uploadRes = await fetch('/api/uploadcloudinary', {
        method: 'POST',
        body: fd,
      })
            ...
            <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
              <div className="_social_registration_right">
                <div className="_social_registration_right_image">
                  <Image src="/assets/images/registration.png" alt="Image" width={633} height={500} priority />
                </div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_registration_content">
                <div className="_social_registration_right_logo _mar_b28">
                  <Image src="/assets/images/logo.svg" alt="Image" width={161} height={40} className="_right_logo" />
                </div>
                <p className="_social_registration_content_para _mar_b8">Get Started Now</p>
                <h4 className="_social_registration_content_title _titl4 _mar_b50">Registration</h4>

                <button type="button" className="_social_registration_content_btn _mar_b40">
                  <Image src="/assets/images/google.svg" alt="Image" width={20} height={20} className="_google_img" />
                ...
                <form className="_social_registration_form" onSubmit={handleSubmit}>
                  ...
                  <div className="col-xl-12 _mar_b20" style={{ textAlign: 'center', marginBottom: 20 }}>
                    <div
                      onClick={() => fileRef.current?.click()}
                      style={{
                        width: 80, height: 80, borderRadius: '50%',
                        background: avatarPreview ? 'transparent' : '#F0F2F5',
                    ...
                    >
                      {avatarPreview ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="#1890FF" strokeWidth="1.5">
                  ...
                  {error && <p className="text-danger _mar_t8">{error}</p>}
