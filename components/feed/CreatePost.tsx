  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/posts', {
        ...
        body: JSON.stringify({
          content: content.trim() || (selectedFile ? 'Shared a photo' : ''),
          imageUrl,
          visibility
        }),
      })
    ...
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          {currentUser.avatar ? (
            <img src={currentUser.avatar} alt="Avatar" className="_txt_img" />
          ) : (
            <div className="_txt_img _nav_profile_initials">
      ...
      {/* Image Preview */}
      {previewUrl && (
        <div className="_mar_t16 _mar_b16" style={{ position: 'relative', display: 'inline-block' }}>
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          ...
          {/* Visibility Dropdown */}
          <div className="_feed_inner_text_area_bottom_visibility _feed_common">
            <select 
              value={visibility}
              onChange={(e) => setVisibility(e.target.value as 'public' | 'private')}
              className="_feed_inner_text_area_bottom_photo_link"
              style={{ background: 'none', border: 'none', outline: 'none', cursor: 'pointer', color: '#666' }}
            >
        ...
        <div className="_feed_inner_text_area_btn">
          <button type="button" onClick={handleSubmit} disabled={loading} className="_feed_inner_text_area_btn_link">
