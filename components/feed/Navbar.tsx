    ...
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        ...
        <button className="navbar-toggler bg-light" type="button"
          ...
          aria-controls="navbarSupportedContent" aria-expanded={isMobileMenuOpen} aria-label="Toggle navigation">
          <span className="navbar-toggler-icon "></span>
        </button>


        <div className={`navbar-collapse ${isMobileMenuOpen ? 'show' : ''}`} id="navbarSupportedContent" style={{ display: isMobileMenuOpen ? 'block' : 'flex', flexBasis: 'auto', flexGrow: 1, alignItems: 'center' }}>
          ...
          <div className="_header_nav_profile" onClick={() => setShowProfileDrop(!showProfileDrop)} style={{ cursor: 'pointer', position: 'relative' }}>
            <div className="_header_nav_profile_image">
              {user.avatar ? (
                ...
                <div className="_nav_profile_img _nav_profile_initials">
              ...
              <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown show`} style={{ display: 'block' }}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    {user.avatar ? (
                      <img src={user.avatar} alt="Profile" className="_nav_drop_img" />
                    ) : (
                      <div className="_nav_drop_img _nav_profile_initials" style={{ width: 44, height: 44 }}>
                        {user.firstName[0]}{user.lastName[0]}
                      </div>
                    )}
                  </div>
                ...
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <button onClick={logout} className="_nav_dropdown_link" style={{ width: '100%', background: 'none', border: 'none', textAlign: 'left', padding: 0, cursor: 'pointer' }}>
                      <div className="_nav_drop_info flex justify-center items-center">
                        <span>
